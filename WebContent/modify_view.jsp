...
<form action="modify.do" method="post">
	...
	<h2>공지사항 수정</h2><br><br>
	<h3>작성자</h3>
	<input type="text" class="signUpInput" name="name" value="${modify_view.name}">
	<h3>제목</h3>
	<input type="text" class="signUpInput" name="title" value="${modify_view.title}">
	<h3>내용</h3>
	<textarea name="content" id="summernote" >${modify_view.content}</textarea>
